...
function initialize(){
  ...
  $('#add').click(add);
  $('#save').click(save);
  db = new Firebase('https://inventory-rf.firebaseio.com/');
...
function add(){
  ...
  var row = '<tr><td class="name"></td><td class="count"></td><td class="cost"></td><td class="room"></td><td class="condition"></td><td class="date"></tr>';
  var $row =$(row);
